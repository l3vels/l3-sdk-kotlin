...
class UtilitiesApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun utilityControllerHealth() : Unit {
        val localVarResponse = utilityControllerHealthWithHttpInfo()
    ...
    fun utilityControllerHealthWithHttpInfo() : ApiResponse<Unit?> {
        val localVariableConfig = utilityControllerHealthRequestConfig()
    ...
    /**
     * To obtain the request config of the operation utilityControllerHealth
     *
     * @return RequestConfig
     */
    fun utilityControllerHealthRequestConfig() : RequestConfig<Unit> {
